...
@section('content')
<!-- header -->
<header class="text-left pl-5">
    <h1>
        Explore <span class="red">Europe</span>
        <h5>As Easy One Click</h5>
    </h1>
    <p class="mt-3">
        All journeys have secret destinations of which traveler is unware <br />
        You will see Beautiful moment you never see before with
    </p>
    <a href="#popular" class="btn btn-get-started px-4 mt-2"> Explore Now </a>
    </header>
    ...
    >
        ...
        <div class="section-popular-travel row justify-content-center">
            ...
            <div class="card card-testimonial text-center">
                ...
                <img
                    ...
                    alt="User"
                    class="mb-4 rounded-circle mt-2"
                />
            ...
            <div class="card card-testimonial text-center">
                ...
                <p class="testimonial">
                    ...
                    Island that makes me feel amazed “
                </p>
                <hr />
        ...
        <div class="row">
            ...
            <a
                ...
                style="background-color: #6e6e6e; color: #fff"
            >
                I Need Help
            </a>
            <a
